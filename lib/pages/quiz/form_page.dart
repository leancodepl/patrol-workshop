...
class _SlideAction extends StatelessWidget {
  const _SlideAction({required this.action});
        ...
        return Container(
          ...
          child: Column(
            children: [
              Text(
                'Ready',
                style: PTTextStyles.bodyBold.copyWith(color: PTColors.textDark),
              ),
              Text(
                'Slide to start',
                style: PTTextStyles.label.copyWith(color: PTColors.textDark),
              ),
            ],
          ),
        );
